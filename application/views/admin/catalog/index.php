...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-info">
			...
			<div class="col-md-4 text-right"><a href="<?php echo admin_url('catalog/add'); ?>" class='btn btn-info'><svg class="glyph stroked plus sign"><use xlink:href="#stroked-plus-sign"/></svg> Add New</a></div>
			</div>
