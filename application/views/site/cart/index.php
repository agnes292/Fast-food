<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 clearpaddingr">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
						...
						if ($total_items > 0) { ?>
							<div class="panel panel-info " style="margin-bottom: 15px">
							  <div class="panel-heading">
							    <h3 class="panel-title">CART( <?php echo $total_items; ?> products )</h3>
							  </div>
							  	...
							  	<table class="table table-hover">
									...
									<?php 
										...
										<tr>
											...
											<td><?php echo number_format($items['subtotal']); ?> USD</td>
									...
									?>
										...
										<tr>
											...
											<td style="font-weight: bold;color:green"><?php echo number_format($total_price); ?> USD</td>
						...
						<?php }else{ ?>
							<div class="panel panel-info " style="margin-bottom: 15px">
							  <div class="panel-heading">
							    <h3 class="panel-title">CART ( 0 item )</h3>
							  </div>
							  <div class="panel-body">
							  	<div class="text-center">
							  		<img src="<?php echo base_url('upload/cart-empty.png') ?>" alt="">
								  	<h4 style="color:red">There is no item in cart</h4>
								 	<a href="<?php echo base_url('product/hot'); ?>" class="btn btn-success">Shop</a>
							 	</div>
