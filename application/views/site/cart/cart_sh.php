      ...
      <div class="table-responsive" style="min-width: 400px;">
         <table class="table table-hover">
          ...
          <tr>
           ...
           <a href="<?php echo base_url('cart'); ?>" type="button" class="btn btn-success"> Cart Details </a>
           <a href="<?php echo base_url('cart/del'); ?>" type="button" class="btn btn-danger pull-right"> Delete </a>
      </div>
    <?php }else{ ?>
        <p style="color:red;font-weight: bold;float: right;padding-right: 30px">No products in cart</p>
    <?php  } ?>
  </ul>
</li>