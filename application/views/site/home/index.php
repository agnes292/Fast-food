<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="logo.png" alt=""><a href="<?php echo base_url('product/news'); ?>" class='product_title'>New Product </a><img src="" alt=""></h3>
	  </div>
...
<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="" alt=""><a href="<?php echo base_url('ban-chay'); ?>" class='product_title'>Best Seller</a><img src="" alt=""></h3>
	  </div>
	  <div class="panel-body">
	  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
...
<div class="row">
	<div class="panel panel-info">
	  <div class="panel-heading">
	    <h3 class="panel-title text-center"><img src="<?php echo base_url(); ?>upload/icon/" alt=""><a href="<?php echo base_url('product/views'); ?>" class='product_title'>Top view</a><img src="" alt=""></h3>
	  </div>
	  <div class="panel-body">
	  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
