...
<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 clearpaddingr">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
		...
		<div class="panel panel-info " style="margin-bottom: 15px">
		  ...
		  <div class="panel-body">
		  	...
		  	<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
		  		...
		  		<a href="<?php echo base_url('cart/add/'.$product->id); ?>" class="btn btn-info"> Add To The Cart</a>
		  	</div>
		  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">
		  		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		  			<img src="<?php echo base_url(); ?>upload/icon/services.png" alt="">
		  			<p style="color:red">Best services</p>
		  		</div>
		  		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		  			<img src="<?php echo base_url(); ?>upload/icon/ship.png" alt="">
		  			<p style="color:red">On time delivery</p>
		  		</div>
		  		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		  			<img src="<?php echo base_url(); ?>upload/icon/services.png" alt="">
		  			<p style="color:red">Change product 24h</p>
		  		</div>
		  	</div>
		  </div>
		</div>
		<div class="panel panel-info">
		  <div class="panel-heading">
		    <h3 class="panel-title">Relative products</h3>
		  </div>
		  <div class="panel-body">
		  	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
	  			...
	  			?>
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 re-padding">
			  			<div class="product_item">
			  				...
			  				<?php	} ?>
							<p><span class="glyphicon glyphicon-eye-open" aria-hidden="true" title="View"></span> <?php echo $value->view; ?> <span class="glyphicon glyphicon-star-empty" aria-hidden="true" title="Số lượng đặt mua"><?php echo $value->buyed; ?></p>
							<a href="<?php echo base_url('cart/add/'.$value->id); ?>"><button class='btn btn-info'><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Add To The Cart</button></a>
			  			</div>
					</div>
				<?php } ?>	
		  	</div>
